...
if ( empty($datosIng) ) {
	...
	if ($datosIng['mod'] == 0) {
		...
		case 0: $mensaje = "<div class='alert alert-success' role='alert'>
			<i class='fas fa-check-circle mx-2'></i>
			Modificación exitosa: ".$datosIng['acnombre']
			.".</div>";
			break;
		case 1: $mensaje = "<div class='alert alert-danger' role='alert'>
			<i class='fas fa-times-circle mx-2'></i>
			<b>Hubo un error al modificar registro de</b> ".$datosIng['acnombre']
			.".</div>";
			break;
		case 2: $mensaje = "<div class='alert alert-danger' role='alert'>
			<i class='fas fa-times-circle mx-2'></i>
...
<div class="container p-2" id=formulario> <!-- Comienzo div resultado -->
